...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.pnlMain.Size = New System.Drawing.Size(768, 128)
        ...
        'btnClose
        '
        Me.btnClose.Location = New System.Drawing.Point(681, 94)
        ...
        'btnClear
        '
        Me.btnClear.Location = New System.Drawing.Point(603, 94)
        ...
        'btnRefresh
        '
        Me.btnRefresh.Location = New System.Drawing.Point(525, 94)
        ...
        Me.dgvReport.Location = New System.Drawing.Point(6, 141)
        Me.dgvReport.Name = "dgvReport"
        Me.dgvReport.ReadOnly = True
        Me.dgvReport.Size = New System.Drawing.Size(768, 162)
        Me.dgvReport.TabIndex = 1
        '
        'cboEntity
        '
        Me.cboEntity.FormattingEnabled = True
        Me.cboEntity.Location = New System.Drawing.Point(280, 66)
        Me.cboEntity.Name = "cboEntity"
        Me.cboEntity.Size = New System.Drawing.Size(473, 21)
        Me.cboEntity.TabIndex = 7
        '
        'Label6
        '
        Me.Label6.AutoSize = True
        Me.Label6.Location = New System.Drawing.Point(232, 68)
...
#End Region
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            If dtpFrom.Checked = True Then lsCond &= " and a.import_date >= '" & Format(CDate(dtpFrom.Value), "yyyy-MM-dd") & "' "
            If dtpTo.Checked = True Then lsCond &= " and a.import_date < '" & Format(DateAdd(DateInterval.Day, 1, dtpTo.Value), "yyyy-MM-dd") & "' "

            If cboEntity.Text <> "" And cboEntity.SelectedIndex >= 0 Then lsCond &= " and a.entity_gid = '" & Val(cboEntity.SelectedValue.ToString) & "' "
            ...
            lsFld = ""
            lsFld &= " e.errmsg_desc as 'Error',"
            lsFld &= " t.entity_code as 'Entity Code',t.entity_name as 'Entity Name',"
            lsFld &= " a.import_date as 'Import Date',a.file_name as 'File Name',a.sheet_name as 'Sheet Name',"
            lsFld &= " a.import_by as 'Import By',"
            lsFld &= " a.file_type as 'File Type',f.file_desc as 'File Type Desc',"
            lsFld &= " e.file_gid as 'File Id',a.entity_gid as 'Entity Id' "

            lsSql = ""
            lsSql &= " select "
            lsSql &= lsFld

            lsSql &= " from arms_trn_terrmsg as e "
            lsSql &= " inner join arms_trn_tfile as a on e.file_gid = a.file_gid and a.delete_flag = 'N' "
            lsSql &= " left join arms_mst_tfile as f on f.file_type = a.file_type and f.delete_flag = 'N' "
            lsSql &= " left join arms_mst_tentity as t on a.entity_gid = t.entity_gid and t.delete_flag = 'N' "
            lsSql &= " where true "
            lsSql &= lsCond
    ...
    Private Sub frmPrfReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Call gpBindCombo("select * from arms_mst_tfile where delete_flag = 'N' order by file_desc", _
    ...
    Private Sub cboFileName_GotFocus(sender As Object, e As EventArgs) Handles cboFileName.GotFocus
        ...
        lsSql = ""
        lsSql &= " select file_gid,concat(file_name,' ',ifnull(sheet_name,'')) as file_name from div_trn_tfile "
        lsSql &= " where 1 = 1"
