Public Class frmCtsCheckList
        ...
        For i = 0 To DGrid.RowCount - 1
            If Not IsDBNull(DGrid.Item(2, i).Value) Then
                If DGrid.Item(2, i).Value = True Then
                    gnCtsDiscVal += DGrid.Item(1, i).Value
                End If
            End If
        Next
    End Sub
    ...
    Sub fp_BindGrid()
        ...
        Try
            gsQry = ""
            gsQry &= " SELECT cts_desc 'CTS Disc', cts_flag "
            gsQry &= " FROM arms_mst_tcts "
            gsQry &= " where delete_flag = 'N' "
            gsQry &= " order by cts_flag asc "
            ...
            If gnCtsDiscVal <> 0 Then
                For i = 0 To DGrid.RowCount - 1
                    If (DGrid.Item(1, i).Value And gnCtsDiscVal) > 0 Then
