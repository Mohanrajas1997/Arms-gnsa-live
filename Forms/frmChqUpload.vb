...
#End Region
    ...
    Sub ImportChqupload()
        ...
        lsFldName(4) = "Contract Number"
        lsFldName(5) = "Cover Number"
        lsFldName(6) = "Cheque No"
        lsFldName(7) = "Cheque Amount"
        ...
        Try
            ...
            fsSql &= " and file_type = " & gnFileChqUpload & " "
            ...
            cmd.Parameters.AddWithValue("?pr_file_type", gnFileChqUpload)
            ...
            With fExcelDatatable
                ...
                While i <= .Rows.Count - 1
                    With .Rows(i)
                        ...
                        Call ConOpenOdbc(ServerDetails)
                        cmd = New MySqlCommand("pr_arms_set_Chequedateupload", gOdbcConn)
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Parameters.AddWithValue("?pr_entity_gid", lnEntityId)
