...
#End Region
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            Using cmd As New MySqlCommand("pr_arms_mst_tbank", gOdbcConn)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.AddWithValue("?pr_bank_gid", id)
                cmd.Parameters("?pr_bank_gid").Direction = ParameterDirection.Input
                cmd.Parameters.AddWithValue("?pr_bank_name", name)
                cmd.Parameters("?pr_bank_name").Direction = ParameterDirection.Input
                cmd.Parameters.AddWithValue("?pr_bank_code", code)
            ...
            Else
                If MsgBox("Are you sure to delete this record ?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, gsProjectName) = MsgBoxResult.Yes Then
                    ...
                    Using cmd As New MySqlCommand("pr_arms_mst_tbank", gOdbcConn)
                        ...
                        cmd.Parameters("?pr_bank_code").Direction = ParameterDirection.Input
                        cmd.Parameters.AddWithValue("?pr_bank_micr_code", 0)
                        cmd.Parameters("?pr_bank_micr_code").Direction = ParameterDirection.Input
