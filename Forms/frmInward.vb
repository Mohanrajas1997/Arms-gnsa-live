...
#End Region
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Select Case ""
            ...
            Case dpReceivedDate.Text
                ...
                Exit Sub
            Case txtChqCount.Text
                MsgBox("Chq Count cannot be empty !", MsgBoxStyle.Critical, gsProjectName)
                dpReceivedDate.Focus()
                Exit Sub
        ...
        If txtId.Text.Trim = "" Then
            ...
            Dim citygid As String = cboCitygid.SelectedValue
            Dim chqcount As String = txtChqCount.Text

            Using cmd As New MySqlCommand("pr_arms_trn_tinward", gOdbcConn)
                Call ConOpenOdbc(ServerDetails)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.AddWithValue("?pr_inward_gid", 0)
                ...
                cmd.Parameters.AddWithValue("?pr_received_date", receiveddate)
                cmd.Parameters("?pr_received_date").Direction = ParameterDirection.Input
                cmd.Parameters.AddWithValue("?pr_received_by", receivedby)
                cmd.Parameters("?pr_received_by").Direction = ParameterDirection.Input
                cmd.Parameters.AddWithValue("?pr_courier_gid", courier)
                ...
                cmd.Parameters.AddWithValue("?pr_inward_remark", remark)
                ...
                cmd.Parameters.AddWithValue("?pr_city_gid", citygid)
                cmd.Parameters("?pr_city_gid").Direction = ParameterDirection.Input
                cmd.Parameters.AddWithValue("?pr_chq_count", chqcount)
                cmd.Parameters("?pr_chq_count").Direction = ParameterDirection.Input
        ...
        Else
            ...
            Using cmd As New MySqlCommand("pr_arms_trn_tinward", gOdbcConn)
                Call ConOpenOdbc(ServerDetails)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.AddWithValue("?pr_inward_gid", id)
                cmd.Parameters("?pr_inward_gid").Direction = ParameterDirection.Input
                cmd.Parameters.AddWithValue("?pr_entity_gid", entity)
                cmd.Parameters("?pr_entity_gid").Direction = ParameterDirection.Input
                cmd.Parameters.AddWithValue("?pr_received_date", receiveddate)
            ...
            Else
                If MsgBox("Are you sure to delete this record?", MsgBoxStyle.YesNo, gsProjectName) = MsgBoxResult.Yes Then
                    ...
                    Using cmd As New MySqlCommand("pr_arms_trn_tinward", gOdbcConn)
                        ...
                        cmd.Parameters("?pr_entity_gid").Direction = ParameterDirection.Input
                        cmd.Parameters.AddWithValue("?pr_received_date", 0)
                        cmd.Parameters("?pr_received_date").Direction = ParameterDirection.Input
                        cmd.Parameters.AddWithValue("?pr_received_by", 0)
                        cmd.Parameters("?pr_received_by").Direction = ParameterDirection.Input
                        cmd.Parameters.AddWithValue("?pr_courier_gid", 0)
                        cmd.Parameters("?pr_courier_gid").Direction = ParameterDirection.Input
                        cmd.Parameters.AddWithValue("?pr_awb_no", 0)
                        cmd.Parameters("?pr_awb_no").Direction = ParameterDirection.Input
                        cmd.Parameters.AddWithValue("?pr_inward_remark", 0)
                        cmd.Parameters("?pr_inward_remark").Direction = ParameterDirection.Input
                        cmd.Parameters.AddWithValue("?pr_action", "DELETE")
                        cmd.Parameters("?pr_action").Direction = ParameterDirection.Input
                        cmd.Parameters.AddWithValue("?pr_city_gid", 0)
                        cmd.Parameters("?pr_city_gid").Direction = ParameterDirection.Input
                        cmd.Parameters.AddWithValue("?pr_chq_count", 0)
                        cmd.Parameters("?pr_chq_count").Direction = ParameterDirection.Input
                        'gsLoginUserCode is global variables
                        cmd.Parameters.AddWithValue("?pr_action_by", gsLoginUserCode)
                        cmd.Parameters("?pr_action_by").Direction = ParameterDirection.Input
    ...
    Private Sub btnFind_Click(sender As Object, e As EventArgs) Handles btnFind.Click
        ...
        Try
            SearchDialog = New frmSearch(gOdbcConn, _
                             ...
                             " entity_name as 'Entity Name',courier_name as 'Courier Name',received_by as 'Received By',received_date as 'Received Date',awb_no as 'AWB NO',inward_remark as 'Inward Remark',city_name as 'City Name',city_gid as 'City Id',chq_count as 'Chq Count' FROM arms_trn_vinward ", _
                             " inward_gid,entity_name,courier_name,received_by,received_date,awb_no,inward_remark,city_name,city_gid,chq_count", _
        ...
        Try
            ...
            With ds.Tables("list_all")
                If .Rows.Count > 0 Then
                    ...
                    cboCitygid.Text = .Rows(0).Item("city_name").ToString
                    txtChqCount.Text = .Rows(0).Item("chq_count").ToString
                Else
                    ClearAll()
                End If
            End With
    ...
    Private Sub frmInward_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            gsQry = " select city_gid, city_name from arms_mst_tcity"
            gsQry &= " where delete_flag='N' "
            gsQry &= " order by city_name "

            Call gpBindCombo(gsQry, "city_name", "city_gid", cboCitygid, gOdbcConn)
