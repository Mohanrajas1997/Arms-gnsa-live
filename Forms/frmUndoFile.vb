...
#End Region
            ...
            Else
                Select Case fnFileType
                    Case "Aplob Input"
                        ...
                        cmd = New MySqlCommand("pr_arms_set_undoAplobInput", gOdbcConn)
                        ...
                        lnres = cmd.Parameters("?pr_result").Value.ToString()
                    ...
                    Case "Pullout"
                        Call ConOpenOdbc(ServerDetails)
                        cmd = New MySqlCommand("pr_arms_set_undopullout", gOdbcConn)
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Parameters.AddWithValue("?pr_file_gid", fnFilegid)
                    ...
                    Case "Presentation"
                        Call ConOpenOdbc(ServerDetails)
                        cmd = New MySqlCommand("pr_arms_set_undorplob", gOdbcConn)
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Parameters.AddWithValue("?pr_file_gid", fnFilegid)
    ...
    Private Sub frmUndoFile_Load(sender As Object, e As EventArgs) Handles Me.Load
