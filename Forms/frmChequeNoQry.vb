...
#End Region
    ...
    Private Sub frmPullout_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        Try
    ...
    Sub ImportPulloutFile()
        ...
        lsFldName(4) = "CHEQUE NO"
        lsFldName(5) = "CHEQUE AMOUNT"
        ...
        Try
            ...
            fsSql &= " and file_type = " & gnFileChequeNoQry & " "
            ...
            lsSql = ""
            lsSql &= " delete from arms_trn_tchequeno_qry "
            lsSql &= " where insert_by = '" & gsLoginUserCode & "' "
            ...
            Using cmd As New MySqlCommand("pr_arms_trn_tfile", gOdbcConn)
                ...
                cmd.Parameters.AddWithValue("?pr_file_type", gnFileChequeNoQry)
            ...
            With fExcelDatatable
                ...
                While i <= .Rows.Count - 1
                    With .Rows(i)
                        ...
                        lsContactNo = Mid(QuoteFilter(.Item("CONTRACT NO").ToString), 1, 64)
                        ...
                        Using cmd As New MySqlCommand("pr_arms_trn_tchequeno_qry", gOdbcConn)
                            Call ConOpenOdbc(ServerDetails)
                            cmd.CommandType = CommandType.StoredProcedure
                            cmd.Parameters.AddWithValue("?pr_chqno_qry_gid", 0)
                            cmd.Parameters("?pr_chqno_qry_gid").Direction = ParameterDirection.Input
                            cmd.Parameters.AddWithValue("?pr_entity_gid", lnEntityId)
                            cmd.Parameters("?pr_entity_gid").Direction = ParameterDirection.Input
